...
double lastOrderedProductWarranty = 3;

String lastReturnedProductName = "Caramida";
...
String lastOrderedProductPriceString = lastOrderedProductPrice.toString();

String lastAccesedProductName = "Tigla";
double lastAccesedProductPrice = 15.99;
String lastAccesedProductSupplier = "Dedeman";

String lastAccesedProductPriceString = lastAccesedProductPrice.toString();

String secondLatestAccesedProductName = "Caramida";
